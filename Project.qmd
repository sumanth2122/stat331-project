...
We began by standardizing the GDP figures, which included some values reported in thousands (denoted with a "k"). These values were converted to numerical form by multiplying them by 1,000. After aligning the year columns and ensuring both datasets were in long format, we joined them based on country and year. Rows with missing values for either GDP or fertility rate were removed. The result was a clean dataset containing matched pairs of GDP per capita and fertility rates across countries and years.

The unit of observation in our analysis is a country-year pair. In some sections, such as model fitting, we aggregate this data at the country level by calculating the average fertility rate and average GDP per capita for each country.
...
To further understand how this relationship has changed over time, we visualized the data as an animated graphic showing how fertility and GDP move year by year. As seen in the animation, countries’ positions shift notably: while the early years show a scattered and less defined relationship, over time the entire cloud of points gradually shifts downward. This movement indicates a collective decline in fertility rates globally, with wealthier nations clustering even lower on the fertility axis. The downward slope becomes more dramatic in more recent years, further emphasizing the strengthening inverse relationship between economic development and fertility.
...
This analysis provides compelling evidence for a negative association between economic prosperity and fertility rates. As GDP per capita increases, fertility rates tend to decline. The regression results are consistent across visualizations and validated by cross-validation, suggesting that GDP per capita is a meaningful, though not exclusive, predictor of fertility behavior across nations.

Future research could explore additional factors such as education levels, urbanization rates, healthcare access, or cultural variables to improve explanatory power. Nonetheless, our findings support existing global demographic theories and provide a statistically grounded visualization of the economic-fertility connection.
